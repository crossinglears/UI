...
{
    [AddComponentMenu("UI/CL_ToggleGroup", 32)]
    ...
    /// </remarks>
    public class CL_ToggleGroup : UIBehaviour
    {
        ...
        protected List<CL_Toggle> m_Toggles = new List<CL_Toggle>();

        protected CL_ToggleGroup()
        {}
        ...
        private void ValidateToggleIsInGroup(CL_Toggle toggle)
        {
        ...
        public void NotifyToggleOn(CL_Toggle toggle, bool sendCallback = true)
        {
        ...
        public void UnregisterToggle(CL_Toggle toggle)
        {
        ...
        public void RegisterToggle(CL_Toggle toggle)
        {
            if (!m_Toggles.Contains(toggle))
        ...
        public void EnsureValidState()
        {
            ...
            IEnumerable<CL_Toggle> activeToggles = ActiveToggles();

            if (activeToggles.Count() > 1)
            {
                CL_Toggle firstActive = GetFirstActiveToggle();

                foreach (CL_Toggle toggle in activeToggles)
                {
        ...
        /// </remarks>
        public IEnumerable<CL_Toggle> ActiveToggles()
        {
        ...
        /// </remarks>
        public CL_Toggle GetFirstActiveToggle()
        {
            IEnumerable<CL_Toggle> activeToggles = ActiveToggles();
